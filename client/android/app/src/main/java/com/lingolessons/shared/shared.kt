...
internal interface UniffiLib : Library {
    ...
    fun uniffi_shared_fn_clone_domain(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun uniffi_shared_fn_free_domain(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
    ...
    fun uniffi_shared_fn_free_domainbuilder(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
    ...
    fun uniffi_shared_fn_method_domainbuilder_build(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun uniffi_shared_fn_method_domainbuilder_data_path(
        `ptr`: Pointer,
    ...
    override suspend fun `getLesson`(`id`: Uuid): Lesson? =
        uniffiRustCallAsync(
            ...
            },
            {
                ...
                continuation,
                ->
                UniffiLib.INSTANCE.ffi_shared_rust_future_poll_rust_buffer(future, callback, continuation)
            },
 ...
 * @suppress
 */
public object FfiConverterTypeAuthError : FfiConverterRustBuffer<AuthError> {
    override fun read(buf: ByteBuffer) =
        try {
            AuthError.values()[buf.getInt() - 1]
...
public object FfiConverterTypeDomainError : FfiConverterRustBuffer<DomainException> {
    override fun read(buf: ByteBuffer): DomainException =
        when (buf.getInt()) {
            ...
            4 ->
                DomainException.Auth(
                    FfiConverterTypeAuthError.read(buf),
                )
    ...
    override fun allocationSize(value: DomainException): ULong =
        when (value) {
            ...
            is DomainException.Auth -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL +
                    FfiConverterTypeAuthError.allocationSize(value.v1)
            )
        }
    ...
    override fun write(
        ...
        when (value) {
            ...
            is DomainException.Auth -> {
                buf.putInt(4)
                FfiConverterTypeAuthError.write(value.v1, buf)
                Unit
            }
