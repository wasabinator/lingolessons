...
for target in "${TARGETS[@]}"; do
  ...
  cargo run --bin uniffi-bindgen generate --library "${RELEASE_DIR}/libshared.dylib" --language swift --out-dir "${OUT_DIR}/"
...
#     "${OUT_DIR}/tutasdk.swift"
  ...
  cp "target/${target}/release/libshared.a" "../ios/lib/${target}/libshared.a"
  cp "${OUT_DIR}/sharedFFI.h" "../ios/lib"
  cp "${OUT_DIR}/shared.swift" "../ios/lib"
